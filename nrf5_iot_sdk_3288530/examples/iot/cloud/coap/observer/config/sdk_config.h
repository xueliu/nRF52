 ...
 *                            trace is observed even if this define is set to 1.
 */
#define IOT_PBUFFER_ENABLE_LOGS                            0
...
/**
 * @brief Maximum size of CoAP client message transmission queue.
 *
 * @details  The maximum number of smartCoAP messages that can be in transmission at the 
 *           same time (client). As smartCoAP is using the memory manager also used by the underlying
 ...
 * 
 * @details If enabled the coap_observe module has to be included. It will enable a the module with 
 *          a table to store observers, and provide access to functions to register and un-register
 ...
 *          un-register observable resources. The observable resources list is used to match 
 *          incomming notifications to a application callback.
 *
 *          Possible values : 0 or 1.
 ...
 *        of time.
 *
 * @details The maximum number of observable reseource to be registered by a client. For each 
...
/**
 * @brief Maximum number of transmit attemps for a Confirmable messages. 
 * 
...
/**
 * @brief Random factor to calculate the initial timeout value for a Confirmable message.
 * 
 * @details Minimum value      : 0
...
/**
 * @brief Delta in seconds when to send automatic update of an observed value.
 * 
 * @details Before a resource reaches its MAX-AGE timeout an observable resource can send an 
 *          update to all of its subscribers. This value indicates how many seconds in front
 *          of a timeout should be used to make sure all the observers has the latest
 *          value before MAX-AGE is reached in the clients.
 * 
 *          Minimum value     : 1
 *          Recommended value : 2
 */
#define COAP_AUTOMODE_OBSERVE_NOTIFY_DELTA_MAX_AGE        2
...
/**
 * @defgroup dns6_config DNS6 client configuration
 * @{
 * @addtogroup iot_config
 * @{
 * @details This section defines configuration of Domain Name System client.
 */
/**
 * @brief Disable debug trace in the module.
 *
...
/**
 * @brief Maximum number of pending queries in queue.
 *
 * @details Maximum number of pending queries in queue.
 *          Minimum value : 1
 *          Maximum value : 65534.
 *          Dependencies  : None.
 */
 ...
 *
 * @details Set this define to 0 to disable retransmissions attempts.
 *          Minimum value : 0
 *          Maximum value : 255.
 *          Dependencies  : None.
 */
#define  DNS6_MAX_RETRANSMISSION_COUNT                     2

/**
 * @brief Interval between retransmissions in seconds.
 *
 * @details Interval between retransmissions in seconds.
 *          Minimum value      : 2
 *          Maximum value      : None.
 *          Dependencies       : None.
 */
