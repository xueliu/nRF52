 ...
 * @{
 * @details This section defines IoT file abstract.
 */
...
/**
 * @brief Interval for timeout process to provide packet retransmission.
 *
 * @details This value should represent one second interval.
 *          Minimum value : 1000.
 *          Maximum value : 1000.
 *          Dependencies  : None.
 */
