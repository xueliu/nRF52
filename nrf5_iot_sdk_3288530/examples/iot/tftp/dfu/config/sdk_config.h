...
/**
 * @defgroup app_dfu Application Device Firmware Upgrade module.
 * @{
 * @addtogroup iot_sdk_common
 * @{
 * @details This section defines configuration of Application DFU module.
 */
 
/**
 * @brief Disable debug trace in the module.
 *
 * @details Set this define to 0 to enable debug trace in the module, else set to 1.
 *          Possible values : 0 or 1.
 *          Dependencies    : ENABLE_DEBUG_LOG_SUPPORT. If this flag is not defined, no
 *                            trace is observed even if this define is set to 0.
 */
 #define APP_DFU_TRANSPORT_ENABLE_LOGS                     0
 
/** @} */
/** @} */

/**
 * @defgroup iot_file IoT file abstract
 * @{
 * @addtogroup iot_sdk_common
 * @{
 * @details This section defines configuration of IoT file abstract.
 */
...
/**
 * @defgroup iot_file_static IoT file port for static buffers Configurations.
 * @{
 * @addtogroup iot_file
 * @{
 * @details This section defines configuration of IoT file port for static buffers.
 */
...
/**
 * @defgroup iot_tftp_config TFTP Client/Server Configuration
 * @{
 * @addtogroup iot_config
 * @{
 * @details This section defines configuration of TFTP module.
 */

/**
 * @brief Maximum amount of TFTP instances.
 *
 * @details Maximum number of TFTP instances.
 *          Minimum value : 1
 *          Dependencies  : None.
 */
 ...
 * @brief Disable debug trace in the module.
 *
 * @details Set this define to 1 to disable debug trace in the module, else set to 0.
 *          Possible values : 0 or 1.
 *          Dependencies    : ENABLE_DEBUG_LOG_SUPPORT. If this flag is not defined, no
 *                            trace is observed even if this define is set to 0.
 */
#define TFTP_ENABLE_LOGS                                   1
...
/** @} */
 ...
 /**
 * @defgroup iot_dfu IoT DFU Configuration
 * @{
 * @addtogroup iot_config
 * @{
 * @details This section defines configuration of the IoT DFU.
 */
 ...
 *          Dependencies    : None.
 */
#define IOT_DFU_DISABLE_API_PARAM_CHECK                    0

/** @} */
/** @} */

 /**
 * @defgroup iot_cjson_hooks IoT Hooks for CJSON configuration
 * @{
 * @addtogroup iot_config
 * @{
 * @details This section defines configuration of the cJSON hooks.
 */
