 ...
 *          can be enabled by defining the SNTP_ENABLE_LOGS.
 * @note That if ENABLE_DEBUG_LOG_SUPPORT is disabled, having SNTP_ENABLE_LOGS has no effect.
 * @{
 */

#if (SNTP_CLIENT_ENABLE_LOGS == 1)
